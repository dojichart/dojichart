...
module.exports = function() {
  ...
  describe("DojiChart.core.BollingerBandsLayer", function() {
    ...
    const INPUT = "close";
    const UPPER_BAND_OUTPUT_PREFIX = "_bb_upper";
    const MID_OUTPUT_PREFIX = "_bb_mid";
    const LOWER_BAND_OUTPUT_PREFIX = "_bb_lower";
    const PERIOD = 10;
    const MULTIPLIER = 2;
    const BAND_COLOR = "green";
    const MID_COLOR = "blue";

    const UPPER_OUTPUT = UPPER_BAND_OUTPUT_PREFIX + PERIOD + "x" + MULTIPLIER;
    const MID_OUTPUT = MID_OUTPUT_PREFIX + PERIOD + "x" + MULTIPLIER;
    const LOWER_OUTPUT = LOWER_BAND_OUTPUT_PREFIX + PERIOD + "x" + MULTIPLIER;

    const MIN_FIELD = LOWER_OUTPUT;
    const MAX_FIELD = UPPER_OUTPUT;
    ...
    const CONFIG = {
      input: INPUT,
      upperBandOutputPrefix: UPPER_BAND_OUTPUT_PREFIX,
      midOutputPrefix: MID_OUTPUT_PREFIX,
      lowerBandOutputPrefix: LOWER_BAND_OUTPUT_PREFIX,
      period: PERIOD,
    ...
    describe("properties", function() {
      ...
      beforeEach(function() {
        layer = new BollingerBandsLayer(CONFIG);
    ...
    describe("methods", function() {
      ...
      afterEach(function() {
        ...
        {
          delete test_data[i][UPPER_OUTPUT];
          delete test_data[i][MID_OUTPUT];
          delete test_data[i][LOWER_OUTPUT];
        }
      });
