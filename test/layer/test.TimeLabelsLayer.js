...
var TimeLabelsLayer = require("../../src/layer/TimeLabelsLayer");

module.exports = function() {

  describe("DojiChart.core.TimeLabelsLayer", function() {

    const CLASS_NAME = "component";
    const COMP_WIDTH = 150;
    ...
    before(function() {
      ...
      CONFIG.timeGrid = {
        lineAt: function(index) {
          return (index === 0 || index === 1) ? true : undefined;
        },
        getLineSpacing: function() { return LINE_SPACING; }
      };
    });
    ...
    describe("properties", function() {
      ...
      beforeEach(function() {
        layer = new TimeLabelsLayer(CONFIG);
    ...
    describe("methods", function() {
      ...
      describe("draw()", function() {
        ...
        it("should add elements to elements property and draw to canvas", function() {
          ...
          expect(layer.elements).to.be.an("array");
          expect(layer.elements).to.have.lengthOf(EXPECTED_LABEL_COUNT);
        });
